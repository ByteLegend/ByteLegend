...
public class WorkflowJobGitHubEvent implements com.bytelegend.app.jsonmodel.event.GitHubEvent {

    @JsonProperty("action")
    private String action;
    @JsonProperty("workflow_job")
    private WorkflowJobGitHubEvent.WorkflowJob workflowJob;
    @JsonProperty("repository")
    private WorkflowJobGitHubEvent.Repository repository;
    @JsonProperty("organization")
    private WorkflowJobGitHubEvent.Organization organization;
    @JsonProperty("sender")
    private WorkflowJobGitHubEvent.Sender sender;
    @JsonIgnore
     ...
     * @param repository
     */
    public WorkflowJobGitHubEvent(String action, WorkflowJobGitHubEvent.WorkflowJob workflowJob, WorkflowJobGitHubEvent.Repository repository, WorkflowJobGitHubEvent.Organization organization, WorkflowJobGitHubEvent.Sender sender) {
        super();
        this.action = action;
    ...
    @JsonProperty("workflow_job")
    public WorkflowJobGitHubEvent.WorkflowJob getWorkflowJob() {
        return workflowJob;
    }

    @JsonProperty("workflow_job")
    public void setWorkflowJob(WorkflowJobGitHubEvent.WorkflowJob workflowJob) {
        this.workflowJob = workflowJob;
    }

    @JsonProperty("repository")
    public WorkflowJobGitHubEvent.Repository getRepository() {
        return repository;
    }

    @JsonProperty("repository")
    public void setRepository(WorkflowJobGitHubEvent.Repository repository) {
        this.repository = repository;
    }

    @JsonProperty("organization")
    public WorkflowJobGitHubEvent.Organization getOrganization() {
        return organization;
    }

    @JsonProperty("organization")
    public void setOrganization(WorkflowJobGitHubEvent.Organization organization) {
        this.organization = organization;
    }

    @JsonProperty("sender")
    public WorkflowJobGitHubEvent.Sender getSender() {
        return sender;
    }

    @JsonProperty("sender")
    public void setSender(WorkflowJobGitHubEvent.Sender sender) {
        this.sender = sender;
    }
    ...
    public String toString() {
        ...
        sb.append(WorkflowJobGitHubEvent.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("action");
        sb.append('=');
        sb.append(((this.action == null)?"<null>":this.action));
        sb.append(',');
        sb.append("workflowJob");
        sb.append('=');
        sb.append(((this.workflowJob == null)?"<null>":this.workflowJob));
        sb.append(',');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.workflowJob == null)? 0 :this.workflowJob.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof WorkflowJobGitHubEvent) == false) {
            return false;
        }
        WorkflowJobGitHubEvent rhs = ((WorkflowJobGitHubEvent) other);
        return (((((((this.sender == rhs.sender)||((this.sender!= null)&&this.sender.equals(rhs.sender)))&&((this.workflowJob == rhs.workflowJob)||((this.workflowJob!= null)&&this.workflowJob.equals(rhs.workflowJob))))&&((this.organization == rhs.organization)||((this.organization!= null)&&this.organization.equals(rhs.organization))))&&((this.action == rhs.action)||((this.action!= null)&&this.action.equals(rhs.action))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.repository == rhs.repository)||((this.repository!= null)&&this.repository.equals(rhs.repository))));
    }
    ...
    public static class Organization {
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append(WorkflowJobGitHubEvent.Organization.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
            sb.append("login");
            sb.append('=');
        ...
        public boolean equals(Object other) {
            ...
            if ((other instanceof WorkflowJobGitHubEvent.Organization) == false) {
                return false;
            }
            WorkflowJobGitHubEvent.Organization rhs = ((WorkflowJobGitHubEvent.Organization) other);
    ...
    public static class Owner {
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append(WorkflowJobGitHubEvent.Owner.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
            sb.append("login");
            sb.append('=');
            sb.append(((this.login == null)?"<null>":this.login));
            sb.append(',');
        ...
        public boolean equals(Object other) {
            ...
            if ((other instanceof WorkflowJobGitHubEvent.Owner) == false) {
                return false;
            }
            WorkflowJobGitHubEvent.Owner rhs = ((WorkflowJobGitHubEvent.Owner) other);
    ...
    public static class Repository {
        ...
        @JsonProperty("owner")
        private WorkflowJobGitHubEvent.Owner owner;
        @JsonProperty("html_url")
        private String htmlUrl;
        @JsonProperty("description")
        private String description;
        ...
        @JsonProperty("owner")
        public WorkflowJobGitHubEvent.Owner getOwner() {
            return owner;
        }

        @JsonProperty("owner")
        public void setOwner(WorkflowJobGitHubEvent.Owner owner) {
            this.owner = owner;
        }
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append(WorkflowJobGitHubEvent.Repository.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
            sb.append("id");
            sb.append('=');
            sb.append(((this.id == null)?"<null>":this.id));
            sb.append(',');
        ...
        public boolean equals(Object other) {
            ...
            if ((other instanceof WorkflowJobGitHubEvent.Repository) == false) {
                return false;
            }
            WorkflowJobGitHubEvent.Repository rhs = ((WorkflowJobGitHubEvent.Repository) other);
    ...
    public static class Sender {
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append(WorkflowJobGitHubEvent.Sender.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
            sb.append("login");
            sb.append('=');
            sb.append(((this.login == null)?"<null>":this.login));
            sb.append(',');
        ...
        public boolean equals(Object other) {
            ...
            if ((other instanceof WorkflowJobGitHubEvent.Sender) == false) {
                return false;
            }
            WorkflowJobGitHubEvent.Sender rhs = ((WorkflowJobGitHubEvent.Sender) other);
            return ((((((((((((((((((((this.receivedEventsUrl == rhs.receivedEventsUrl)||((this.receivedEventsUrl!= null)&&this.receivedEventsUrl.equals(rhs.receivedEventsUrl)))&&((this.siteAdmin == rhs.siteAdmin)||((this.siteAdmin!= null)&&this.siteAdmin.equals(rhs.siteAdmin))))&&((this.followingUrl == rhs.followingUrl)||((this.followingUrl!= null)&&this.followingUrl.equals(rhs.followingUrl))))&&((this.gistsUrl == rhs.gistsUrl)||((this.gistsUrl!= null)&&this.gistsUrl.equals(rhs.gistsUrl))))&&((this.avatarUrl == rhs.avatarUrl)||((this.avatarUrl!= null)&&this.avatarUrl.equals(rhs.avatarUrl))))&&((this.organizationsUrl == rhs.organizationsUrl)||((this.organizationsUrl!= null)&&this.organizationsUrl.equals(rhs.organizationsUrl))))&&((this.reposUrl == rhs.reposUrl)||((this.reposUrl!= null)&&this.reposUrl.equals(rhs.reposUrl))))&&((this.htmlUrl == rhs.htmlUrl)||((this.htmlUrl!= null)&&this.htmlUrl.equals(rhs.htmlUrl))))&&((this.subscriptionsUrl == rhs.subscriptionsUrl)||((this.subscriptionsUrl!= null)&&this.subscriptionsUrl.equals(rhs.subscriptionsUrl))))&&((this.login == rhs.login)||((this.login!= null)&&this.login.equals(rhs.login))))&&((this.type == rhs.type)||((this.type!= null)&&this.type.equals(rhs.type))))&&((this.url == rhs.url)||((this.url!= null)&&this.url.equals(rhs.url))))&&((this.starredUrl == rhs.starredUrl)||((this.starredUrl!= null)&&this.starredUrl.equals(rhs.starredUrl))))&&((this.gravatarId == rhs.gravatarId)||((this.gravatarId!= null)&&this.gravatarId.equals(rhs.gravatarId))))&&((this.followersUrl == rhs.followersUrl)||((this.followersUrl!= null)&&this.followersUrl.equals(rhs.followersUrl))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.eventsUrl == rhs.eventsUrl)||((this.eventsUrl!= null)&&this.eventsUrl.equals(rhs.eventsUrl))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.nodeId == rhs.nodeId)||((this.nodeId!= null)&&this.nodeId.equals(rhs.nodeId))));
        }
    ...
    public static class WorkflowJob {
         ...
         * @param status
         */
        public WorkflowJob(Long id, Long runId, String runUrl, String nodeId, String headSha, String url, String htmlUrl, String status, Object conclusion, String startedAt, Object completedAt, String name, List<Object> steps, String checkRunUrl, List<String> labels, Long runnerId, String runnerName, Long runnerGroupId, String runnerGroupName) {
            super();
            this.id = id;
            this.runId = runId;
            this.runUrl = runUrl;
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append(WorkflowJobGitHubEvent.WorkflowJob.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
            sb.append("id");
            sb.append('=');
            sb.append(((this.id == null)?"<null>":this.id));
            sb.append(',');
        ...
        public boolean equals(Object other) {
            ...
            if ((other instanceof WorkflowJobGitHubEvent.WorkflowJob) == false) {
                return false;
            }
            WorkflowJobGitHubEvent.WorkflowJob rhs = ((WorkflowJobGitHubEvent.WorkflowJob) other);
