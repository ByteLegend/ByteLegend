...
public class ListReleasesResponse {
    ...
    @JsonProperty("author")
    private ListReleasesResponse.Author author;
    @JsonProperty("assets")
    private List<ListReleasesResponse.Asset> assets = new ArrayList<ListReleasesResponse.Asset>();
    @JsonIgnore
     ...
     * @param assetsUrl
     */
    public ListReleasesResponse(String url, String htmlUrl, String assetsUrl, String uploadUrl, String tarballUrl, String zipballUrl, Long id, String nodeId, String tagName, String targetCommitish, String name, String body, Boolean draft, Boolean prerelease, String createdAt, String publishedAt, ListReleasesResponse.Author author, List<ListReleasesResponse.Asset> assets) {
        super();
        this.url = url;
    ...
    @JsonProperty("author")
    public ListReleasesResponse.Author getAuthor() {
        return author;
    }

    @JsonProperty("author")
    public void setAuthor(ListReleasesResponse.Author author) {
        this.author = author;
    }

    @JsonProperty("assets")
    public List<ListReleasesResponse.Asset> getAssets() {
        return assets;
    }

    @JsonProperty("assets")
    public void setAssets(List<ListReleasesResponse.Asset> assets) {
        this.assets = assets;
    }
    ...
    public String toString() {
        ...
        sb.append(ListReleasesResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("url");
        sb.append('=');
    ...
    public static class Asset {
        ...
        private ListReleasesResponse.Uploader uploader;
        @JsonIgnore
        private Map<String, Object> additionalProperties = new HashMap<String, Object>();
         ...
         * @param updatedAt
         */
        public Asset(String url, String browserDownloadUrl, Long id, String nodeId, String name, String label, String state, String contentType, Long size, Long downloadCount, String createdAt, String updatedAt, ListReleasesResponse.Uploader uploader) {
            super();
            this.url = url;
        ...
        @JsonProperty("uploader")
        public ListReleasesResponse.Uploader getUploader() {
            return uploader;
        }

        @JsonProperty("uploader")
        public void setUploader(ListReleasesResponse.Uploader uploader) {
            this.uploader = uploader;
        }
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append(ListReleasesResponse.Asset.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
            sb.append("url");
            sb.append('=');
            sb.append(((this.url == null)?"<null>":this.url));
            sb.append(',');
        ...
        public boolean equals(Object other) {
            ...
            if ((other instanceof ListReleasesResponse.Asset) == false) {
                return false;
            }
            ListReleasesResponse.Asset rhs = ((ListReleasesResponse.Asset) other);
    ...
    public static class Author {
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append(ListReleasesResponse.Author.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
            sb.append("login");
            sb.append('=');
        ...
        public boolean equals(Object other) {
            ...
            if ((other instanceof ListReleasesResponse.Author) == false) {
                return false;
            }
            ListReleasesResponse.Author rhs = ((ListReleasesResponse.Author) other);
    ...
    public static class Uploader {
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append(ListReleasesResponse.Uploader.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
            sb.append("login");
            sb.append('=');
            sb.append(((this.login == null)?"<null>":this.login));
            sb.append(',');
        ...
        public boolean equals(Object other) {
            ...
            if ((other instanceof ListReleasesResponse.Uploader) == false) {
                return false;
            }
            ListReleasesResponse.Uploader rhs = ((ListReleasesResponse.Uploader) other);
            return ((((((((((((((((((((this.receivedEventsUrl == rhs.receivedEventsUrl)||((this.receivedEventsUrl!= null)&&this.receivedEventsUrl.equals(rhs.receivedEventsUrl)))&&((this.siteAdmin == rhs.siteAdmin)||((this.siteAdmin!= null)&&this.siteAdmin.equals(rhs.siteAdmin))))&&((this.followingUrl == rhs.followingUrl)||((this.followingUrl!= null)&&this.followingUrl.equals(rhs.followingUrl))))&&((this.gistsUrl == rhs.gistsUrl)||((this.gistsUrl!= null)&&this.gistsUrl.equals(rhs.gistsUrl))))&&((this.avatarUrl == rhs.avatarUrl)||((this.avatarUrl!= null)&&this.avatarUrl.equals(rhs.avatarUrl))))&&((this.organizationsUrl == rhs.organizationsUrl)||((this.organizationsUrl!= null)&&this.organizationsUrl.equals(rhs.organizationsUrl))))&&((this.reposUrl == rhs.reposUrl)||((this.reposUrl!= null)&&this.reposUrl.equals(rhs.reposUrl))))&&((this.htmlUrl == rhs.htmlUrl)||((this.htmlUrl!= null)&&this.htmlUrl.equals(rhs.htmlUrl))))&&((this.subscriptionsUrl == rhs.subscriptionsUrl)||((this.subscriptionsUrl!= null)&&this.subscriptionsUrl.equals(rhs.subscriptionsUrl))))&&((this.login == rhs.login)||((this.login!= null)&&this.login.equals(rhs.login))))&&((this.type == rhs.type)||((this.type!= null)&&this.type.equals(rhs.type))))&&((this.url == rhs.url)||((this.url!= null)&&this.url.equals(rhs.url))))&&((this.starredUrl == rhs.starredUrl)||((this.starredUrl!= null)&&this.starredUrl.equals(rhs.starredUrl))))&&((this.gravatarId == rhs.gravatarId)||((this.gravatarId!= null)&&this.gravatarId.equals(rhs.gravatarId))))&&((this.followersUrl == rhs.followersUrl)||((this.followersUrl!= null)&&this.followersUrl.equals(rhs.followersUrl))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.eventsUrl == rhs.eventsUrl)||((this.eventsUrl!= null)&&this.eventsUrl.equals(rhs.eventsUrl))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.nodeId == rhs.nodeId)||((this.nodeId!= null)&&this.nodeId.equals(rhs.nodeId))));
        }
