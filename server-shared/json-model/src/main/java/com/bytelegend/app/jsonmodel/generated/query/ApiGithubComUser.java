...
public class ApiGithubComUser {
    ...
    @JsonProperty("plan")
    private ApiGithubComUser.Plan plan;
    @JsonIgnore
     ...
     * @param nodeId
     */
    public ApiGithubComUser(String login, Long id, String nodeId, String avatarUrl, String gravatarId, String url, String htmlUrl, String followersUrl, String followingUrl, String gistsUrl, String starredUrl, String subscriptionsUrl, String organizationsUrl, String reposUrl, String eventsUrl, String receivedEventsUrl, String type, Boolean siteAdmin, String name, String company, String blog, String location, String email, Object hireable, Object bio, Object twitterUsername, Long publicRepos, Long publicGists, Long followers, Long following, String createdAt, String updatedAt, Long privateGists, Long totalPrivateRepos, Long ownedPrivateRepos, Long diskUsage, Long collaborators, Boolean twoFactorAuthentication, ApiGithubComUser.Plan plan) {
        super();
        this.login = login;
        this.id = id;
        this.nodeId = nodeId;
    ...
    @JsonProperty("plan")
    public ApiGithubComUser.Plan getPlan() {
        return plan;
    }

    @JsonProperty("plan")
    public void setPlan(ApiGithubComUser.Plan plan) {
        this.plan = plan;
    }
    ...
    public String toString() {
        ...
        sb.append(ApiGithubComUser.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("login");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ApiGithubComUser) == false) {
            return false;
        }
        ApiGithubComUser rhs = ((ApiGithubComUser) other);
    ...
    public static class Plan {
         ...
         * @param space
         */
        public Plan(String name, Long space, Long collaborators, Long privateRepos) {
            super();
            this.name = name;
            this.space = space;
            this.collaborators = collaborators;
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append(ApiGithubComUser.Plan.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
            sb.append("name");
            sb.append('=');
            sb.append(((this.name == null)?"<null>":this.name));
            sb.append(',');
        ...
        public boolean equals(Object other) {
            ...
            if ((other instanceof ApiGithubComUser.Plan) == false) {
                return false;
            }
            ApiGithubComUser.Plan rhs = ((ApiGithubComUser.Plan) other);
