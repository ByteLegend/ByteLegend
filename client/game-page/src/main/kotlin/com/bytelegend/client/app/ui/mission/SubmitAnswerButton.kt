...
class SubmitAnswerButton(props: SubmitAnswerButtonProps) :
    Component<SubmitAnswerButtonProps, SubmitAnswerButtonState>(props) {
    ...
    init {
        state = jso {
            ...
            if (props.game.activeScene.challengeAnswers.getPullRequestChallengeAnswersByChallengeId(props.challengeId)
                    .anyCheckRunning()
            ) {
                spinning = true
    ...
    override fun render() = Fragment.create {
        ...
        div { //
            ...
            img {
                ...
                jsStyle {
                    cursor = state.borderCursor
                }
                onMouseDown = this@SubmitAnswerButton::onMouseDown
                onMouseUp = this@SubmitAnswerButton::onMouseUp
                onMouseOut = this@SubmitAnswerButton::onMouseUp
                onBlur = {
                    this@SubmitAnswerButton.onMouseUp(it.unsafeCast<MouseEvent<Element, NativeMouseEvent>>())
                }
                onMouseMove = this@SubmitAnswerButton::onMouseMove
            }
            div {
                className = ClassName("submit-answer-button-button")
                span {
