...
class SubmitAnswerButton(props: SubmitAnswerButtonProps) : RComponent<SubmitAnswerButtonProps, SubmitAnswerButtonState>(props) {
    ...
    override fun SubmitAnswerButtonState.init(props: SubmitAnswerButtonProps) {
        top = loadTop() ?: 0
        left = loadLeft() ?: 0
        ...
        div("submit-answer-button") {
            ...
            img {
                ...
                if (state.glow) {
                    ...
                    attrs.classes = jsObjectBackedSetOf("submit-answer-button-border")
                }
                attrs.src =
                ...
                attrs.onMouseDownFunction = this@SubmitAnswerButton::onMouseDown
                attrs.onMouseUpFunction = this@SubmitAnswerButton::onMouseUp
                attrs.onMouseOutFunction = this@SubmitAnswerButton::onMouseUp
                attrs.onBlurFunction = this@SubmitAnswerButton::onMouseUp
            ...
            div("submit-answer-button-animation") {
                attrs.jsStyle {
                    zIndex = "1"
